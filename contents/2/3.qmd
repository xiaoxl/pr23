...
Let's look at three typical examples of iterators.
...
If you want to loop through two lists simutanously, you may use `zip()` function. It will create a new list which combines two lists. Please see the following example: elements from list `a` and list `b` are zipped into tuples.
