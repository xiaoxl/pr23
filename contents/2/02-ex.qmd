...
1. To directly use the formula we have to use a high performance math package, e.g. `math`. Please use `math.factorial()` to compute the above formula. You should `import math` to use the function since it is in the `math` package.
